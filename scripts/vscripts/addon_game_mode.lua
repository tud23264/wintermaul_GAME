...
TOWERPRECACHE = {"nature_pool","terran_protector","gaias_box","earths_soul","ground_pounder","gaia"}
WAVE = 1
ENEMIESLEFT = 144
...
function Precache( context )
		...
		for i =1,6 do
			PrecacheUnitByNameAsync( TOWERPRECACHE[i], context)
			PrecacheModel( TOWERPRECACHE[i], context )
		end
